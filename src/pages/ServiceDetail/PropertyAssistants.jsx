// src/pages/ServiceDetail/PropertyAssistants.jsx
import React, { useState } from 'react';

import {  FaCheck, FaStar, FaChevronDown, FaChevronUp, FaHome } from 'react-icons/fa';
import CallToAction from '../../components/CallToAction';
import ConsultationForm from '../../components/ConsultationForm';

const PropertyAssistants = () => {
  ...
  const serviceData = {
    ...
    whyOutsource: [
      {
        ...
        description: 'Reduce property management time by 70% with our skilled assistants handling tenant communications, maintenance coordination, and administrative tasks.'
      },
      {
        title: 'Enhanced Tenant Satisfaction',
        description: '24/7 tenant support coverage ensures prompt responses and higher satisfaction rates, leading to better tenant retention.'
      },
      {
        title: 'Flexible Management',
        description: 'Scale your property management support based on portfolio size and seasonal demands. Perfect for growing real estate portfolios.'
      }
    ],
    advantages: [
    ...
    benefits: [
      {
        title: 'Cost Savings',
        description: 'Save 60% compared to local hires while maintaining professional property management standards.'
      },
      {
        title: 'Improved Operations',
        description: 'Streamlined communication processes and automated rent collection tracking for better operations.'
      },
      {
        title: 'Increased Efficiency',
        description: 'Professional handling of property listings, tenant coordination, and maintenance requests.'
      },
      {
        title: 'Greater Flexibility',
        description: 'Easily scale support for multiple properties or adjust based on seasonal demands.'
      }
    ],
    testimonials: [
      {
        ...
        content: 'Our property assistants have transformed how we manage 50+ properties. Tenant satisfaction is at an all-time high!',
        rating: 5
      },
      {
        name: 'Sarah Chen',
        ...
        content: 'The cost savings and efficiency gains have been incredible. Highly recommended for any property portfolio.',
        rating: 5
      }
    ],
    faqs: [
      {
        question: 'What tasks can property assistants handle?',
        answer: 'Our property assistants manage tenant communications, rent collection, maintenance coordination, property listings, lease agreements, and inspection scheduling.'
      },
      {
        question: 'How do you ensure quality in property management?',
        answer: 'All property assistants undergo specialized training in real estate protocols, tenant relations, and property management software.'
      },
      {
        question: 'Can assistants handle emergency maintenance requests?',
        answer: 'Yes, we provide 24/7 support for emergency maintenance coordination and tenant communications.'
      }
    ]
  };
...
{/* About Property Assistants Section */}
<section className="relative py-20 bg-gradient-to-b from-white to-yellow-50 overflow-hidden">
  <div className="max-w-7xl mx-auto px-6 lg:px-8">
    <div className="grid lg:grid-cols-2 gap-12 items-center">
      ...
      <div className="text-center lg:text-left">
        <h2 className="text-4xl md:text-5xl font-extrabold text-gray-900 mb-4">
          About Our <span className="text-yellow-500">Property Assistants</span>
        </h2>
        <div className="w-24 h-1 bg-yellow-400 mx-auto lg:mx-0 mb-8 rounded-full"></div>

        <p className="text-lg text-gray-700 leading-relaxed mb-6">
          Our Property Assistants provide end-to-end support for landlords, property managers, and real estate investors.
        </p>
        <p className="text-lg text-gray-700 leading-relaxed mb-8">
          From lease management to tenant communication and maintenance coordination, our virtual assistants handle everything efficiently.
        </p>
      </div>
      ...
      <div className="relative">
        <div className="rounded-3xl overflow-hidden shadow-xl">
          <img
            ...
            alt="Property Assistant working"
    ...
    <div className="mt-16 grid sm:grid-cols-2 lg:grid-cols-4 gap-6 text-center">
      {[
        { title: "Tenant Communication Experts", desc: "Maintain seamless communication with tenants for smooth operations." },
        { title: "Lease & Document Management", desc: "Handle contracts, agreements, and property documentation efficiently." },
        { title: "Maintenance Coordinators", desc: "Schedule and oversee property repairs and upkeep." },
        { title: "Property Portfolio Support", desc: "Manage multiple properties with attention to detail and professionalism." },
      ].map((role, index) => (
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">Transform your property management with our expert assistants</p>
          </div>
...
export default PropertyAssistants;