    ...
    whyOutsource: [
      {
        ...
        description: 'Reduce legal research time by 70% with our trained legal assistants handling case preparation and documentation.'
      },
      {
    ...
    benefits: [
      {
        ...
        description: 'Save 70% compared to local legal assistants while maintaining professional legal support standards.'
      },
      {
