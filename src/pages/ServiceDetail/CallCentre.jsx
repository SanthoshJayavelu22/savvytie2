  ...
  const serviceData = {
    ...
    whyOutsource: [
      ...
      },
      {
        ...
        description: 'Achieve 60% cost savings compared to local call centers while maintaining high-quality customer service standards.'
      },
      {
    ...
    benefits: [
      {
        ...
        description: 'Save 60% compared to local call centers while getting professional customer service and technical support.'
      },
      {
